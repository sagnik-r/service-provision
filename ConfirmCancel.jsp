...
<%
	...
	out.println("<h2 style = 'font-family:georgia,garamond,serif;font-size:20px;font-style:bold;'>Are you sure you want to cancel this Booking : </h2><br>");
	...
	out.println("<button type = 'submit'>Confirm Cancel</button></div></form>");
